const startup_provider_Modal = () => {
  const modal = 
        
  {
	"type": "modal",
	"callback_id": "startup_provider2",
	"title": {
		"type": "plain_text",
	...
	"blocks": [
		...
		},
		{
			...
			"label": {
				"type": "plain_text",
				"text": "Line of service you are looking for",
				"emoji": true
			}
		},
		{
			...
			"label": {
				"type": "plain_text",
				"text": "Select your preferred Partner Region",
				"emoji": true
			}
		},
		{
			...
			"label": {
				"type": "plain_text",
				"text": "Type of partner you are looking for",
				"emoji": true
			}
		}
	]
...
module.exports = {startup_provider_Modal};